...
norm_hutau_S1_sta=hutau_S1(Ind_S1:Ind_S1_fi);
norm_hutau_S2_sta=hutau_S2(Ind_S2:Ind_S2_fi);
norm_hutau_S3_sta=hutau_S3(Ind_S3:Ind_S3_fi);
norm_hutau_S4_sta=hutau_S4(Ind_S4:Ind_S4_fi);
norm_hutau_S5_sta=hutau_S5(Ind_S5:Ind_S5_fi);
norm_hutau_S6_sta=hutau_S6(Ind_S6:Ind_S6_fi);
norm_hutau_S7_sta=hutau_S7(Ind_S7:Ind_S7_fi);


MAX_S1=max(abs(norm_hutau_S1_sta))
MAX_S2=max(abs(norm_hutau_S2_sta))
MAX_S3=max(abs(norm_hutau_S3_sta))
MAX_S4=max(abs(norm_hutau_S4_sta))
MAX_S5=max(abs(norm_hutau_S5_sta))
MAX_S6=max(abs(norm_hutau_S6_sta))
MAX_S7=max(abs(norm_hutau_S7_sta))
...
pos = leg.Position;
set(leg,...
    'Position',pos+[-0.55 -0.3 +0.05 0.35])

leg.Direction = 'reverse';

% xlabel('$t\,[s]$','fontsize',12);
% ylabel('$u_{\tau}\,[N\,m]$','fontsize',12)

yh=ylabel('$u_{\tau}\,[N\,m]$','fontsize',12)
