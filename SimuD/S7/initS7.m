...
parameters.uSlopeThreshold=uSlopeThreshold;
...
parameters.beta_bar=1;%
parameters.sigma=1;%
parameters.k=1;%
timer0=parameters.beta_bar;%beta
...
[~,~,~,~,~,Vcal_memory0]=errs(x0,ref0,parameters);

xi0=[x0;huT0;hutau0;timer0;Vcal_memory0];
