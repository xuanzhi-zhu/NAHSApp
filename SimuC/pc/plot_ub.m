...
rms_zp_ss_i_0=rms(norm_zp_i_0(aux:end));
ub_zp_i_0=ub_zp;
clear t j zp

load data_i_1 t j zp ub_zp
t_i_1=t;
j_i_1=j;
%find the index of an event
...
rms_zp_ss_i_1=rms(norm_zp_i_1(aux:end));
ub_zp_i_1=ub_zp;
clear t j zp

load data_i_2 t j zp ub_zp
t_i_2=t;
j_i_2=j;
%find the index of an event
...
rms_zp_ss_i_2=rms(norm_zp_i_2(aux:end));
ub_zp_i_2=ub_zp;
clear t j zp

load data_i_3 t j zp ub_zp
t_i_3=t;
j_i_3=j;
%find the index of an event
...
rms_zp_ss_i_3=rms(norm_zp_i_3(aux:end));
ub_zp_i_3=ub_zp;
clear t j zp

load data_i_4 t j zp ub_zp
t_i_4=t;
j_i_4=j;
%find the index of an event
...
rms_zp_ss_i_4=rms(norm_zp_i_4(aux:end));
ub_zp_i_4=ub_zp;
clear t j zp

load data_i_5 t j zp ub_zp
t_i_5=t;
j_i_5=j;
%find the index of an event
...
rms_zp_ss_i_5=rms(norm_zp_i_5(aux:end));
ub_zp_i_5=ub_zp;
clear t j zp

load data_i_6 t j zp ub_zp
t_i_6=t;
j_i_6=j;
%find the index of an event
...
rms_zp_ss_i_6=rms(norm_zp_i_6(aux:end));
ub_zp_i_6=ub_zp;
clear t j zp

load data_i_7 t j zp ub_zp
t_i_7=t;
j_i_7=j;
...
rms_zp_ss_i_7=rms(norm_zp_i_7(aux:end));
ub_zp_i_7=ub_zp;
clear t j zp

load data_i_8 t j zp ub_zp
t_i_8=t;
j_i_8=j;
%find the index of an event
...
rms_zp_ss_i_8=rms(norm_zp_i_8(aux:end));
ub_zp_i_8=ub_zp;
clear t j zp

load data_i_9 t j zp ub_zp
t_i_9=t;
j_i_9=j;
%find the index of an event
...
rms_zp_ss_i_9=rms(norm_zp_i_9(aux:end));
ub_zp_i_9=ub_zp;
clear t j zp
...
aux_zp_rms=[rms_zp_ss_i_0;rms_zp_ss_i_1;...
                      rms_zp_ss_i_2;rms_zp_ss_i_3;...
                      rms_zp_ss_i_4;rms_zp_ss_i_5;...
                      rms_zp_ss_i_6;rms_zp_ss_i_7;...
                      rms_zp_ss_i_8;rms_zp_ss_i_9];

aux_ub_zp=[ub_zp_i_0;ub_zp_i_1;...
                    ub_zp_i_2;ub_zp_i_3;...
                    ub_zp_i_4;ub_zp_i_5;...
                    ub_zp_i_6;ub_zp_i_7;...
                    ub_zp_i_8;ub_zp_i_9];
...
h_aux_ub=plot(aux_i,aux_ub_zp,...
    markers{9},'MarkerEdgeColor',black,'LineWidth',lineWidth,'MarkerSize',markerSize);hold on;
h_auxss=plot(aux_i,aux_zp_rms,...
...
leg=legend({'$\sqrt{\bar{a}}$','$\text{RMS}_{t\geq 30}\{|p(t,j)-p_d(t,j)|\}$'},'fontsize',12);
legend('boxoff')
