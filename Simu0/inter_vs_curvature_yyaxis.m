...
yyaxis left
plot(t_event(2:end),t_inter(2:end),'diamond','MarkerEdgeColor',black,'LineWidth',0.1,'MarkerSize',markerSize);
grid on
xlabel('$t\,[s]$','fontsize',12)
ylabel('$t_{j+1}-t_j\,[s]$','fontsize',12)

yyaxis right
plot(t,curvature,'-','Color',grey,'LineWidth',lineWidth,'MarkerSize',markerSize);hold on;
grid on
xlabel('$t\,[s]$','fontsize',12)
...
leg=legend({'$t_{j+1}-t_j$','$\kappa$'},'fontsize',12);
legend('boxoff')
